...
function adventure() {
    ...
    switch (true) {
        case r < 11:
            return 'You nearly died. You have nasty scars on your body, and you are missing an ear, ' + random.dice('1d3') + ' fingers, or ' + random.dice('1d4') + ' toes.';
        case r < 21:
        ...
        case r < 91:
            return 'You found some treasure on your adventure. You have ' + random.dice('2d6') + ' gp left from your share of it.';
        case r < 100:
            return 'You found a considerable amount of treasure on your adventure. You have ' + (random.dice('1d20') + 50) + ' gp left from your share of it.';
        default:
            return 'You came across a common magic item';
    }
}
...
function arcane() {
    switch (random.dice('1d10')) {
        ...
        case 5:
            return 'You found a spell scroll and succeeded in casting the Spell it contained.';
        case 6:
        ...
        case 10:
            return 'Your fortune was read by a diviner. They told you: \n1. ' + event([]) + ' \n2. ' + event([]);
    }
}
...
function boon() {
    switch (random.dice('1d10')) {
        case 1:
            return 'A friendly wizard gave you a spell scroll containing one cantrip';
        case 2:
        ...
        case 4:
            return 'You found some money. You have ' + random.dice('1d20') + ' gp in addition to your regular starting funds.';
        case 5:
            return 'A relative bequeathed you a simple weapon of your choice.';
        case 6:
            return 'You found ' + Item.trinket();
        case 7:
        ...
        case 10:
            return 'A distant relative left you a stipend that enables you to live at the comfortable lifestyle for ' + random.dice('1d20') + ' years. If you choose to live at a higher lifestyle, you reduce the price of the lifestyle by 2 gp during that time period.';
    }
}
...
function punishment() {
    ...
    switch (true) {
        ...
        case r < 13:
            return 'You were caught and convicted. You spent time in jail, chained to an oar, or performing hard labor. You served a sentence of ' + random.dice('1d4') + ' years or succeeded in escaping after that much time.';
    }
}
...
function supernatural() {
    ...
    switch (true) {
        case r < 6:
            return 'You were ensorcelled by a fey and enslaved for ' + random.dice('1d6') + ' years before you escaped.';
        case r < 11:
            return 'You saw a demon and ran away before it could do anything to you.';
        case r < 16:
            return 'A devil tempted you. Make a DC 10 Wisdom saving throw. On a failed save, your alignment shifts one step toward evil (if it\'s not evil already), and you start the game with an additional ' + (random.dice('1d20') + 50) + ' gp.';
        case r < 21:
        ...
        case r < 76:
            return 'You were briefly possessed by a ' + possessedCreature() + '.';
        case r < 81:
...
function tragedy() {
    switch (random.dice('1d12')) {
        case 1:
        case 2:
            return 'A family member or a close friend died. Cause of death: ' + causeOfDeath() + '.';
        case 3:
        ...
        case 5:
            return 'You were imprisoned for a crime you didn\'t commit and spent ' + random.dice('1d6') + ' years at hard labor, in jail, or shackled to an oar in a slave galley.';
        case 6:
        ...
        case 11:
            return 'A romantic relationship ended. ' + (random.bool() ? 'with bad feelings.' : 'but it was amicable.');
        case 12:
            return 'A current or prospective romantic partner of yours died. Cause of death: ' + causeOfDeath() + '.' + (random.bool(8) ? ' It was your fault.' : '');
    }
}
...
function weirdStuff() {
    switch (random.dice('1d12')) {
        case 1:
            return 'You were turned into a toad and remained in that form for ' + random.dice('1d4') + ' weeks.';
        case 2:
            return 'You were petrified and remained a stone statue for a time until someone freed you.';
        case 3:
            return 'You were enslaved by a hag, a satyr, or some other being and lived in that creature\'s thrall for ' + random.dice('1d6') + ' years.';
        case 4:
            return 'A dragon held you as a prisoner for ' + random.dice('1d12') + ' months until adventurers killed it.';
        case 5:
        ...
        case 7:
            return 'You went insane for ' + random.dice('1d6') + ' years and recently regained your sanity. A tic or some other bit of odd behavior might linger.';
        case 8:
            return 'A lover of yours was secretly a ' + metallic() + ' dragon.';
        case 9:
...
function event(previous) {
    ...
    switch (true) {
        ...
        case r < 21:
            return boon();
        case r < 31:
            return previous.filter(function (n) {
                return n < 31 && n >= 21;
            }).length > 1 ? 'You had a child.' : 'You fell in love or got married.';
        case r < 41:
            return 'You made an enemy of an adventuring ' + Class.random().name + ' ' + (random.bool() ? 'but it wasn\'t your fault.' : 'and it was your fault.');
        case r < 51:
            return 'You made a friend of an adventuring ' + Class.random().name + '.';
        case r < 71:
            return 'You spent time working in a job related to your background. Start the game with an extra ' + random.dice('2d6') + ' gp.';
        case r < 76:
            return 'You met someone important.';
        case r < 81:
            return 'You went on an adventure. ' + adventure();
        case r < 86:
            return supernatural();
        case r < 91:
            return 'You fought in a battle. ' + war();
        case r < 96:
            return 'You were accused of ' + crime() + '. ' + punishment();
        case r < 100:
            return arcane();
        default:
            return weirdStuff();
...
function occupation() {
    ...
    switch (true) {
        case r < 6:
            return 'works as an academic';
        case r < 11:
            return 'works as an adventuring ' + Class.random().name;
        case r < 12:
            return 'is an aristocrat';
        case r < 27:
            return 'works as an artisan or guild member';
        case r < 32:
            return 'is a criminal';
        case r < 37:
            return 'works as an entertainer';
        case r < 39:
            return 'is an exile, hermit or refugee';
        case r < 44:
            return 'is an explorer or wanderer';
        case r < 56:
            return 'works as a farmer or herder';
        case r < 61:
            return 'works as a hunter or trapper';
        case r < 76:
            return 'works as a laborer';
        case r < 81:
            return 'works as a merchant';
        case r < 86:
            return 'works as a politician or bureaucrat';
        case r < 91:
            return 'works as a priest';
        case r < 96:
            return 'works as a sailor';
        case r < 101:
            return 'serves as a soldier';
        default:
            return weirdStuff();
    }
}
...
function relationship() {
    var r = random.dice('3d4');
    switch (true) {
        case r < 5:
            return 'You are hostile towards each other.';
        case r < 11:
            return 'You get on with each other.';
        case r < 13:
            return 'You are indifferent to each other.';
    }
}
...
module.exports = {
    ...
    age: function age() {
        ...
        switch (true) {
            case r < 21:
                return random.numberBetween(16, 20);
            case r < 60:
                return random.numberBetween(21, 30);
            case r < 70:
                return random.numberBetween(31, 40);
            case r < 90:
                return random.numberBetween(41, 50);
            case r < 100:
                return random.numberBetween(51, 60);
            default:
                return random.numberBetween(61, 100);
        }
    },
    relativeAge: function relativeAge() {
        var r = random.dice('2d6');
        switch (true) {
            case r < 3:
                return 'twin';
            case r < 8:
    ...
    childhood: function childhood(charismaModifier) {
        var r = random.dice('3d6') + charismaModifier;
        switch (true) {
            case r < 4:
                return 'You are still haunted by your childhood, where you were treated badly by your peers.';
            case r < 6:
                return 'You spent most of your childhood alone, with no close friends.';
            case r < 9:
                return 'Others saw you as different or strange, and so you had few companions.';
            case r < 13:
    ...
    eventCount: function eventCount(age) {
        switch (true) {
            case age < 21:
                return 1;
            case age < 60:
                return random.dice('1d4');
            case age < 70:
                return random.dice('1d6');
            case age < 90:
                return random.dice('1d8');
            case age < 100:
                return random.dice('1d10');
            default:
                return random.dice('1d12');
        }
    },
    adventure: adventure,
    arcane: arcane,
