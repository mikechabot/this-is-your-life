const Alignment = require('./character/alignment');
const Class = require('./character/class');
const Race = require('./character/race');
const Background = require('./background/background');
const Family = require('./background/family');
const Birth = require('./background/birth');
const Life = require('./background/life');
